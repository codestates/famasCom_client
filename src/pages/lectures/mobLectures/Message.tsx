...
const Message = () => {
    ...
    <Wra>
      ...
      <LectureTemplateBlock>
        ...
        <LectureUpper/>
            <LectureBox>
                <HeadText>문자메세지 보내기</HeadText>
                <Stepper className={classes.root}>
                  <img
                  className={classes.img}
                  src={MsgText[activeStep].imgPath}
                  alt={MsgText[activeStep].label}
                  />
                  <Paper square elevation={0} className={classes.header}>
                  <Typography className={classes.text}>{MsgText[activeStep].label}</Typography>
                  </Paper>                
                  <MobileStepper
